...
// The kernel file is "kernels_beam_elements-finalversion.cl"
...
int main(int argc, char** argv)
{
    ...
    constexpr st_block_size_t const MAX_NUM_BEAM_ELEMENTS       = 1000u;
    constexpr st_block_size_t const NUM_OF_BEAM_ELEMENTS        = 1000u;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   std::string PATH_TO_KERNEL_FILE( st_PATH_TO_BASE_DIR );
       PATH_TO_KERNEL_FILE += "../kernels_beam_elements-finalversion.cl";
...
queue.enqueueWriteBuffer( B, CL_TRUE, 0, st_Blocks_get_total_num_bytes( &beam_elements ), st_Blocks_get_const_data_begin( &beam_elements ) );
  ...
  // Allocate device buffers and transfer input data to device.
    ...
    track_beam_particle.setArg(0,B);
    track_beam_particle.setArg(1,C);
    track_beam_particle.setArg(2,NUM_PARTICLES);
    track_beam_particle.setArg(3,NUM_TURNS);


    cl::Event event;

    queue.enqueueNDRangeKernel(
    track_beam_particle, cl::NullRange, cl::NDRange( numThreads ),
